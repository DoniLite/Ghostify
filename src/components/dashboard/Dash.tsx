...
const Dashboard = () => {
  return (
    <div class='p-5 w-full h-full transition-all overflow-y-scroll'>
      {/* Header */}
      ...
      {/* Subscription Card */}
      <div class='bg-gradient-to-r from-primary to-secondary text-gray-950 rounded-lg p-6 mb-8 relative overflow-hidden'>
          ...
          <table class='min-w-full'>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class='py-4 px-4 border-b border-slate-200'>500 / mois</td>
                <td class='py-4 px-4 border-b border-slate-200'>5 actifs</td>
              ...
              <tr class='bg-secondary/5'>
                ...
                <td class='py-4 px-4 border-b border-slate-200'>Illimité</td>
                <td class='py-4 px-4 border-b border-slate-200'>
