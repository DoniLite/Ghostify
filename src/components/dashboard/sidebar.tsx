...
const Sidebar = () => {
  return (
    <div className="h-full bg-slate-200 text-gray-950 shadow-lg shadow-gray-950 transition-all duration-100">
      ...
      <div className="py-4">
        {/* Main Menu */}
        <div className="showOrHide hidden px-5 py-2 text-xs uppercase tracking-wider text-slate-400 transition-all">
          Principal
        </div>
        <a
          href="#"
          className="hover:text-primary before:bg-primary relative flex items-center bg-white/10 px-5 py-3 text-gray-950 before:absolute before:left-0 before:top-0 before:h-full before:w-1 hover:bg-white/10"
        >
        ...
        {/* Account Menu */}
        <div className="showOrHide mt-2 hidden px-5 py-2 text-xs uppercase tracking-wider text-slate-400 transition-all">
          Compte
        </div>
        <a
          href="#"
