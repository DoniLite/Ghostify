      ...
      <div className='container mx-auto flex flex-col lg:flex-row items-center justify-between gap-12'>
        <div className='relative flex-1 flex justify-center lg:justify-start'>
          <div className='relative w-full max-w-md h-64 lg:h-96'>
            ...
            <CodingSVG className='absolute inset-0 w-full h-full' />
          </div>
        </div>
...
const CodingSVG = ({ ...rest }: Record<string, unknown>) => (
  ...
  >
    <title>Coding</title>
    <style type='text/css' dangerouslySetInnerHTML={{ __html: svgStyle }}>
    </style>
    <g id='screen'>
      <g id='screen-3'>
        <polygon
       ...
       L135.2,232.1z'
        ...
        <rect className='st2' x='300.6' y='132.3' width='7.4' height='3.9'>
        </rect>
        <rect className='st1' x='318.6' y='132.3' width='34' height='3.9'>
        </rect>
        <rect className='st1' x='251.8' y='142.1' width='13.7' height='3.9'>
        </rect>
        <rect className='st1' x='272.8' y='142.1' width='35.2' height='3.9'>
        </rect>
        <rect className='st1' x='316.4' y='142.1' width='13.4' height='3.9'>
        </rect>
        <rect className='st2' x='241.2' y='132' width='4.6' height='3.9'></rect>
        <rect className='st2' x='237.9' y='142.1' width='5.5' height='3.9'>
        </rect>
        <rect className='st2' x='235.2' y='154.1' width='5.5' height='3.9'>
        </rect>
        <rect className='st1' x='249.9' y='154.1' width='31.6' height='3.9'>
        </rect>
        <rect
          className='st1'
          x='291.9'
        ...
        <rect className='st2' x='321.6' y='171.5' width='7.4' height='3.9'>
        </rect>
        <rect className='st1' x='339.6' y='171.5' width='34' height='3.9'>
        </rect>
        <rect className='st1' x='272.8' y='181.3' width='13.7' height='3.9'>
        </rect>
        <rect className='st1' x='293.8' y='181.3' width='35.2' height='3.9'>
        </rect>
        <rect className='st2' x='337.4' y='181.3' width='13.4' height='3.9'>
        </rect>
        <rect className='st1' x='262.2' y='171.1' width='4.6' height='3.9'>
        </rect>
        <rect className='st2' x='258.9' y='181.3' width='5.5' height='3.9'>
        </rect>
        <rect className='st1' x='256.2' y='193.3' width='5.5' height='3.9'>
        </rect>
        <rect className='st1' x='270.9' y='193.3' width='31.6' height='3.9'>
        </rect>
      </g>
      <polygon
        className='st2'
    ...
    <g id='plant'>
     ...
     l-1,19.3l-1.6,30.9l-0.4,7.1C425.9,449.3,430.5,447.7,430.6,446.3z'
      ...
      <ellipse className='st2' cx='409.2' cy='388.9' rx='23.8' ry='5.6'>
      </ellipse>
      <path
        className='st2'
    ...
    <g id='character'>
     ...
     c-0.8,0.3-1.6,0.7-2.3,1.1l-10.8,5.1l-8.3,3.9c-0.9,0.4-1.8,1.5-1.2,2.5S103.1,433.9,104.1,433.5L104.1,433.5z'
      ...
      <rect className='st2' x='80.4' y='297.5' width='88.7' height='14.3'>
      </rect>
      <path
        className='st2'
