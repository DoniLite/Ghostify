...
const ServiceCard = ({ icon, title, description, features, apiCode }: ServiceCardProps) => (
  <div className="bg-card border-border flex w-full flex-col items-start rounded-xl border p-8 text-left shadow-lg lg:w-1/3">
    ...
    <h3 className="text-foreground font-nunito mb-3 text-2xl font-bold">{title}</h3>
  ...
  return (
    <section className="bg-background px-6 py-20 text-center lg:px-12">
      <div className="container mx-auto">
        ...
        <h2 className="text-foreground font-nunito mb-12 mt-4 text-4xl font-extrabold lg:text-5xl">
