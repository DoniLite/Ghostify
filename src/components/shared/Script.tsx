export default function () {
  return (
    <>
      <script type='module' src='/static/js/frontend/shared.js'></script>
      <script type='module' src='/static/js/frontend/notifications.js'></script>
      <script type='module' src='/static/js/frontend/translator.js'></script>
