...
export abstract class BaseRepository<
	...
	CreateDTO extends PgInsertValue<PgTableWithColumns<Tb>>,
	UpdateDTO extends PgUpdateSetSource<PgTableWithColumns<Tb>>,
	Tb extends BaseTable = BaseTable,
> implements CrudOperations<T, CreateDTO, UpdateDTO>
{
	protected db = DatabaseConnection.getInstance().getDatabase();
	protected abstract table: PgTableWithColumns<Tb>;
