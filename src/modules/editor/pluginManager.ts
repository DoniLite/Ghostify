...
import { Bold, GitBranch, LinkIcon, List, MessageCircle, Table } from 'lucide-react';
import { RichTextPluginComponent } from './plugins/richText.plugin.tsx';
import { PluginConfig } from './types.ts';
import { HeadingNode, QuoteNode } from '@lexical/rich-text';
import { LinkNode } from '@lexical/link';
import { CommentsPluginComponent } from './plugins/comments.plugin.tsx';
import { LinksPluginComponent } from './plugins/links.plugin.tsx';
import { ListsPluginComponent } from './plugins/lists.plugin.tsx';
import { RevisionsPluginComponent } from './plugins/revisions.plugin.tsx';
import { TablesPluginComponent } from './plugins/tables.plugin.tsx';
    ...
    constructor() {
      this.pluginRegistry = {
        ...
        'comments': {
          ...
          nodes: [/* Custom CommentNode could go here */],
        },
        'revisions': {
          id: 'revisions',
          ...
          nodes: [/* Custom RevisionNode could go here */],
        },
      };
    }
